...
?>
	<main class="py-5">
		...
		<div class="container">
            ...
            <div>
                <div>
                    <h2>Hi! My name is Nate Manyande and I’m a web developer based in Leeds. I work for a digital agency called DS.Emotion and I mainly do front-end development, building WordPress websites for various clients in the property industry.</h2>
                ...
                <div>
                    <img src="https://via.placeholder.com/650x810" alt="">
                </div>
            </div>
